...
${OBJECTDIR}/src/splunk-conf-beautifier.o: src/splunk-conf-beautifier.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/splunk-conf-beautifier.o src/splunk-conf-beautifier.cpp
...
${OBJECTDIR}/src/splunk-conf-beautifier_nomain.o: ${OBJECTDIR}/src/splunk-conf-beautifier.o src/splunk-conf-beautifier.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/splunk-conf-beautifier_nomain.o src/splunk-conf-beautifier.cpp;\
	else  \
