...
${OBJECTDIR}/src/splunk-conf-formater.o: src/splunk-conf-formater.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/splunk-conf-formater.o src/splunk-conf-formater.cpp
...
${OBJECTDIR}/src/splunk-conf-formater_nomain.o: ${OBJECTDIR}/src/splunk-conf-formater.o src/splunk-conf-formater.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/splunk-conf-formater_nomain.o src/splunk-conf-formater.cpp;\
	else  \
